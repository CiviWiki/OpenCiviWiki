...
cw.FeedView = BB.View.extend({
  ...
  render: function() {
    ...
    var filtered_categories = _.filter(
      this.options.categories,
      function(c) {
        return _.contains(user_categories, c.id);
      },
      user_categories
    );
  ...
  updatePriorityNav: function() {
    ...
    var navWidth =
      this.$("#user-categories-list > li.dropdown-wrapper").width() +
    ...
    if (navWidth > containerWidth) {
      ...
      if (navWidth + firstDropdownElement.data("width") < containerWidth) {
        firstDropdownElement.insertBefore(
          this.$("#user-categories-list > li.dropdown-wrapper")
        );
      }
    }
  },
