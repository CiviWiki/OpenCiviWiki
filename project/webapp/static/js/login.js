...
cw.LoginView = BB.View.extend({
  ...
  renderForms: function() {
    if (this.register) {
      this.$("#entry-content")
        .empty()
        .append(this.registerTemplate());
    } else {
      this.$("#entry-content")
        .empty()
        .append(this.loginTemplate());
    }
  },
  ...
  login: function() {
    ...
    if (username && password) {
      ...
      Materialize.toast(
        '<span class="subtitle-lato white-text">Please input your username and password</span>',
        5000
      );
    }
  },
  ...
  register: function() {
    ...
    if (!email.is(":valid")) {
      Materialize.toast(
        '<span class="subtitle-lato white-text">Please enter a valid email</span>',
        5000
      );
      ...
      Materialize.toast(
        '<span class="subtitle-lato white-text">Please fill all the fields</span>',
        5000
      );
    }
  }
