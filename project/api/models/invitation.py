...
class Invitation(models.Model):
    ...
    host_user = models.ForeignKey(User, default=None, null=True, related_name="hosts", on_delete=models.SET_NULL)
    invitee_email = models.EmailField(default=None, null=False)
    verification_code = models.CharField(max_length=31, null=False)
    invitee_user = models.ForeignKey(User, default=None, null=True, related_name="invitees", on_delete=models.SET_NULL)
