    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('last_modified', models.DateTimeField(auto_now=True, null=True)),
                ('author', models.ForeignKey(default=None, to='api.Account', null=True, on_delete=models.SET_NULL)),
                ('category', models.ForeignKey(default=None, to='api.Category', null=True, on_delete=models.SET_NULL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('civi', models.ForeignKey(default=None, to='api.Civi', null=True, on_delete=models.SET_NULL)),
            ],
        ),
        migrations.AddField(
            model_name='notification',
            name='thread',
            field=models.ForeignKey(default=None, to='api.Thread', null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='civi',
            name='thread',
