    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default=b"federal",
                        max_length=31,
                        choices=[(b"federal", b"Federal"), (b"state", b"State")],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(max_length=255, serialize=False, primary_key=True),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                default=None, to="api.Bill", null=True, on_delete=models.PROTECT
            ),
        ),
        migrations.CreateModel(
            name="Vote",
        ...
        migrations.AddField(
            ...
            name="vote",
            field=models.ForeignKey(
                default=None, to="api.Vote", null=True, on_delete=models.PROTECT
            ),
        ),
        migrations.AddField(
            model_name="rationale",
