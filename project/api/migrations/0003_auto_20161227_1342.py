    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(default=None, to='api.Account', null=True, on_delete=models.SET_NULL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='civi',
            name='bill',
            field=models.ForeignKey(default=None, to='api.Bill', null=True, on_delete=models.SET_NULL),
        ),
        migrations.CreateModel(
            name='Vote',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('last_modified', models.DateTimeField(auto_now=True, null=True)),
                ('bill', models.ForeignKey(default=None, to='api.Bill', null=True, on_delete=models.SET_NULL)),
                ('representative', models.ForeignKey(default=None, to='api.Representative', null=True, on_delete=models.SET_NULL)),
            ],
        ),
        migrations.CreateModel(
            name='Rationale',
        ...
        migrations.AddField(
            ...
            name='vote',
            field=models.ForeignKey(default=None, to='api.Vote', null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='rationale',
            name='representative',
            field=models.ForeignKey(default=None, to='api.Representative', null=True, on_delete=models.SET_NULL),
        ),
