    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "longitude",
                    models.DecimalField(default=0, max_digits=9, decimal_places=6),
                ),
                (
                    "latitude",
                    models.DecimalField(default=0, max_digits=9, decimal_places=6),
                ...
                (
                    "fed_district",
                    models.CharField(default=None, max_length=63, null=True),
                ),
                (
                    "state_district",
                    models.CharField(default=None, max_length=63, null=True),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                default=None, to="api.Response", null=True, on_delete=models.PROTECT
            ),
        ),
        migrations.AddField(
            model_name="civi",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="_account_followers_+", to="api.Account"
            ),
        ),
        migrations.AddField(
            model_name="account",
            name="following",
            field=models.ManyToManyField(
                related_name="_account_following_+", to="api.Account"
            ),
        ),
        migrations.AddField(
            model_name="account",
