    ...
    **NOTE** that the times are in milliseconds in this class!
    ...
    def call_later(self, delay, func, *args, **kwargs):
        ...
        try:
            ...
            diff = (old_div(real_time, 1000.0)) - now
    ...
    def _notify_bucket(self, real_time):
        ...
        delay_ms = old_div(self._bucket_milliseconds, math.ceil(old_div(float(len(calls)), self._chunk_size)))
