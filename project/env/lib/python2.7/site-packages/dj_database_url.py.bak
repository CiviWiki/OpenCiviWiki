...
urllib.parse.uses_netloc.append('pgsql')
urllib.parse.uses_netloc.append('postgis')
urllib.parse.uses_netloc.append('mysql')
urllib.parse.uses_netloc.append('mysql2')
urllib.parse.uses_netloc.append('mysqlgis')
urllib.parse.uses_netloc.append('mysql-connector')
urllib.parse.uses_netloc.append('spatialite')
urllib.parse.uses_netloc.append('sqlite')
urllib.parse.uses_netloc.append('oracle')
urllib.parse.uses_netloc.append('oraclegis')
...
def parse(url, engine=None, conn_max_age=0):
    ...
    config.update({
        'NAME': urllib.parse.unquote(path or ''),
