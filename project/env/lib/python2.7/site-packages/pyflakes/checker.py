...
if PY2:
    def getNodeType(node_class):
        ...
        return str(str(node_class.__name__).upper())
else:
    def getNodeType(node_class):
...
class FunctionScope(Scope):
    ...
    def unusedAssignments(self):
        ...
        """
        for name, binding in list(self.items()):
...
class Checker(object):
        ...
        for scope in self.deadScopes:
            ...
            if undefined:
                ...
                if scope.importStarred:
                    for binding in list(scope.values()):
    ...
    def DICT(self, node):
        ...
        duplicate_keys = [
            key for key, count in list(key_counts.items())
            if count > 1
        ]
        ...
        for key in duplicate_keys:
            ...
            if any(count == 1 for value, count in list(values.items())):
