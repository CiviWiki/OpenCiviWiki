...
class AdviceTests(unittest.TestCase):
    ...
    def test_single_explicit_meta(self):
        ...
        class Concrete(with_metaclass(Metaclass, Metaclass)):
            ping([],1)
    ...
    def test_mixed_metas(self):
        ...
        class Base1(with_metaclass(Metaclass1, object)):
            pass

        class Base2(with_metaclass(Metaclass2, object)):
            pass
        ...
        class Derived(with_metaclass(Metaclass3, type('NewBase', (Base1, Base2), {}))):
            ping([], 1)
...
class Test_determineMetaclass(unittest.TestCase):
    ...
    def test_multiple_in_hierarchy(self):
        ...
        class Meta_B(Meta_A):
            pass
        class A(with_metaclass(Meta_A, type)):
            pass
        class B(with_metaclass(Meta_B, type)):
            pass
