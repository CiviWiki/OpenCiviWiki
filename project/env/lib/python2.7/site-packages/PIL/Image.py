...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def rotate(self, angle, resample=NEAREST, expand=0):
        ...
        # adjust center
        x, y = transform(old_div(w, 2.0), old_div(h, 2.0))
        matrix[2] = old_div(self.size[0], 2.0) - x
        matrix[5] = old_div(self.size[1], 2.0) - y
    ...
    def __transformer(self, box, image, method, data,
        ...
        if method == AFFINE:
            ...
            x0, y0, x1, y1 = data
            xs = old_div(float(x1 - x0), w)
            ys = old_div(float(y1 - y0), h)
            method = AFFINE
