...
class AltitudeTests(TestCase):
    ...
    def test_value(self):
        ...
        self.assertEqual(altitude.inFeet, old_div(1.,base.METERS_PER_FOOT))
...
class SpeedTests(TestCase):
    ...
    def test_inKnots(self):
        ...
        self.assertEqual(old_div(1,base.MPS_PER_KNOT), speed.inKnots)
...
class ClimbTests(TestCase):
    ...
    def test_speedInKnots(self):
        ...
        self.assertEqual(old_div(1,base.MPS_PER_KNOT), climb.inKnots)
