...
class OSCARUser(object):
    ...
    def __str__(self):
        ...
        if hasattr(self, 'sessionLength'): o.append('online for %i minutes' % (old_div(self.sessionLength,60),))
...
class SNACBased(OscarConnection):
    ...
    def oscar_01_03(self, snac):
        numFamilies = old_div(len(snac[3]),2)
...
class BOSConnection(SNACBased):
    ...
    def oscar_01_10(self,snac):
        ...
        newLevel = old_div(struct.unpack('!H',snac[3][2+skip:4+skip])[0],10)
