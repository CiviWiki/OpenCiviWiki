...
class SimpleRouter(BaseRouter):
    ...
    def get_routes(self, viewset):
        ...
        # different functions.
        known_actions = list(flatten([list(route.mapping.values()) for route in self.routes if isinstance(route, Route)]))
    ...
    def get_method_map(self, viewset, method_map):
        ...
        """
        bound_methods = {}
        for method, action in list(method_map.items()):
...
class APIRootView(views.APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        for key, url_name in list(self.api_root_dict.items()):
            if namespace:
