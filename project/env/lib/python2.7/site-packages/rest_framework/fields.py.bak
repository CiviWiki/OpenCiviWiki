...
if six.PY3:
    ...
    def is_simple_callable(obj):
        ...
        if method:
            is_unbound = obj.__self__ is None
...
def iter_options(grouped_choices, cutoff=None, cutoff_text=None):
    ...
    for key, value in list(grouped_choices.items()):
...
class Field(object):
    ...
    def __deepcopy__(self, memo):
        ...
        kwargs = {
            ...
            for key, value in list(self._kwargs.items())
        }
...
class ChoiceField(Field):
    ...
    def __init__(self, choices, **kwargs):
        ...
        self.choice_strings_to_values = {
            six.text_type(key): key for key in list(self.choices.keys())
        }
