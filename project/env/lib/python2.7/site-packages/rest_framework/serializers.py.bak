        ...
        for base in reversed(bases):
            if hasattr(base, '_declared_fields'):
                fields = [
                    ...
                    in list(base._declared_fields.items())
...
class Serializer(BaseSerializer):
    ...
    def _writable_fields(self):
        return [
            field for field in list(self.fields.values())
...
def raise_errors_on_nested_writes(method_name, serializer, validated_data):
    ...
    * Automatically create a profile instance.
    ...
    assert not any(
        ...
        for key, field in list(serializer.fields.items())
    ), (
...
class ModelSerializer(Serializer):
    ...
    * Default `.create()` and `.update()` implementations are provided.
    ...
    def get_uniqueness_extra_kwargs(self, field_names, declared_fields, extra_kwargs):
        ...
        for model_field in list(model_fields.values()):
        ...
        for key, value in list(uniqueness_extra_kwargs.items()):
    ...
    def get_unique_for_date_validators(self):
        ...
        * unique_for_year
        ...
        field_names = [field.source for field in list(self.fields.values())]

        validators = []

        for field_name, field in list(info.fields_and_pk.items()):
